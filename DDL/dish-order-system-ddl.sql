...
CONSTRAINT worker_c_fk FOREIGN KEY (username) REFERENCES `User`(username),
CONSTRAINT worker_b_fk FOREIGN KEY (branch_id) REFERENCES Branch(branch_id)
);
...
CONSTRAINT order_b_fk FOREIGN KEY (branch_id) REFERENCES Branch(branch_id)
);
...
CONSTRAINT cust_paycard_p_fk FOREIGN KEY (paycard_id) REFERENCES Paycard(paycard_id),
CONSTRAINT cust_paycard_c_fk FOREIGN KEY (username) REFERENCES Customer(username)
);
...
CONSTRAINT reward_cd_fk FOREIGN KEY (coupon_id) REFERENCES Coupon_Dict(coupon_id),
CONSTRAINT reward_c_fk FOREIGN KEY (username) REFERENCES Customer(username)
);
...
CONSTRAINT delivery_info_fk FOREIGN KEY (order_id) REFERENCES `Order`(order_id),
CONSTRAINT delivery_info_ds_fk FOREIGN KEY (branch_id) REFERENCES Delivery_Setting(branch_id),
CONSTRAINT delivery_info_c_fk FOREIGN KEY (username) REFERENCES Customer(username)
);
...
CONSTRAINT branch_catalog_b_fk FOREIGN KEY (branch_id) REFERENCES Branch(branch_id),
CONSTRAINT branch_catalog_c_fk FOREIGN KEY (catalog_id) REFERENCES Catalog_Dict(catalog_id)
);
...
CONSTRAINT dish_dict_fk FOREIGN KEY (catalog_id) REFERENCES Catalog_Dict(catalog_id)
);
...
CONSTRAINT dish_d_fk FOREIGN KEY (dish_id) REFERENCES Dish_Dict(dish_id)
);
